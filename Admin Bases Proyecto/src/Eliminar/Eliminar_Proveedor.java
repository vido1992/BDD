...
public class Eliminar_Proveedor extends javax.swing.JInternalFrame {
 ...
 DefaultTableModel modelo=(DefaultTableModel) tablaEliminarProveedor.getModel();
        String consulta="select NOMBREPROVEEDOR, DIRECCIONPROVEEDOR, TELEFONOPROVEEDOR "
                + "from PROVEEDORES WHERE NOMBREPROVEEDOR="+Buscar.getText()+";";
        rs=ConexionSQL.Consulta(consulta);
        ...
        try {
            while (rs.next()){
                ...
                modelo.addRow(new Object[] {rs.getString("NOMBREPROVEEDOR"),rs.getString("DIRECCIONPROVEEDOR"),
