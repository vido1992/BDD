...
public class Eliminar_Usuario extends javax.swing.JInternalFrame {
   ...
   ResultSet rs;
    ...
    private void initComponents() {
        ...
        tablaeliminarusuario = new javax.swing.JTable();
        ...
        tablaeliminarusuario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablaeliminarusuario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tablaeliminarusuarioMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tablaeliminarusuario);
    ...
    private void tablaeliminarusuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaeliminarusuarioMouseClicked

        seleccionar=tablaeliminarusuario.rowAtPoint(evt.getPoint());
    }//GEN-LAST:event_tablaeliminarusuarioMouseClicked

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        DefaultTableModel modelo=(DefaultTableModel) tablaeliminarusuario.getModel();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DefaultTableModel modelo=(DefaultTableModel) tablaeliminarusuario.getModel();
        String consulta="select p.NOMBREPERSONA,p.APELLIDOPERSONA,p.TELEFONOPERSONA,u.LOGINUSUARIO,u.PRIVILEGIOSUSUARIO "
                        +"from PERSONA as p join USUARIO as u on p.IDPERSONA=u.IDPERSONA "
                + "WHERE LOGINUSUARIO="+Buscar.getText()+";";
        rs=ConexionSQL.Consulta(consulta);
        ...
        try {
            while (rs.next()){
                ...
                modelo.addRow(new Object[] {rs.getString("NOMBREPERSONA"),rs.getString("APELLIDOPERSONA"),
                    rs.getString("TELEFONOPERSONA"),rs.getString("LOGINUSUARIO"),rs.getString("PRIVILEGIOSUSUARIO")});
 ...
 DefaultTableModel modelo=(DefaultTableModel) tablaeliminarusuario.getModel();
    ...
    private javax.swing.JTable tablaeliminarusuario;
