...
public class Eliminar_Producto extends javax.swing.JInternalFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DefaultTableModel modelo=(DefaultTableModel) tablaEliminarProducto.getModel();
        String consulta="SELECT NOMBREPRODUCTO,DESCRIPCIONPRODUCTO,PRECIOUPRODUCTO,CANTIDADPRODUCTO,FECHAVPRODUCTO "
                + "FROM PRODUCTO WHERE NOMBREPRODUCTO="+Buscar.getText()+";";
        rs=ConexionSQL.Consulta(consulta);
