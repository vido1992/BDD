...
create table ENTRADAREGISTROPRODUCTO (
   ...
   OBSERVACIONESENTRADAP varchar(30)          null,
...
create table PERSONA (
   ...
   DIRECIONPERSONA      varchar(50)          null,
...
create table PROVEEDORES (
   ...
   DIRECCIONPROVEEDOR   varchar(30)          null,
...
create table SALIDAREGISTRO (
   ...
   OBSERVACIONESSALIDA  varchar(30)          null,
...
create table SECTOR (
   ...
   DESCRIPCIONSECTOR    varchar(30)          null,
...
create table USUARIO (
   ...
   PASSWORDUSUARIO      varchar(15)          null,
